...
export const allPlaceholders = {
    "Nouns": [
        ...
        { internalType: "NN_Onomatopoeia", display: "Sound", tooltip: "Sound word (bang, buzz)", icon: "fas fa-volume-up", isPrimary: false }
    ],
    "Verbs": [
        ...
        { internalType: "VB_Onomatopoeia", display: "Sound", tooltip: "Sound verb (meow, boom)", icon: "fas fa-volume-up", isPrimary: false },
    ...
    "Descriptors": [
        ...
        { internalType: "JJ_Emotion", display: "Emotion Adjective", tooltip: "Describes feelings (happy, sad)", icon: "fas fa-smile", isPrimary: false },
        { internalType: "JJ_Color", display: "Color Adjective", tooltip: "Describes colors (red, green)", icon: "fas fa-paint-brush", isPrimary: false },
        { internalType: "JJ_Size", display: "Size Adjective", tooltip: "Describes size (big, small)", icon: "fas fa-arrows-alt", isPrimary: false },
    ...
    "Other": [
        { internalType: "FW", display: "Foreign Word", tooltip: "Non-English (bonjour, sushi)", icon: "fas fa-globe", isPrimary: true },
        ...
        { internalType: "DT_Quantifier", display: "Quantifier", tooltip: "Indicates quantity (some, many)", icon: "fas fa-calculator", isPrimary: true },
