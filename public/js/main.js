    ...
    const Storage = {
      ...
      `);
        ...
        populateEditorWithStory: (story, mode) => {
            ...
            State.fillValues = story.State.fillValues || {};
            State.pronounGroups = story.State.pronounGroups || {};
            State.pronounGroupCount = story.State.pronounGroupCount || 0;
            State.customPlaceholders = story.State.customPlaceholders || [];
