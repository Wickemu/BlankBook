...
var initEvents = function initEvents() {
  ...
  $(document).on('click', '.placeholder-btn', function (e) {
    if (_core_state_js__WEBPACK_IMPORTED_MODULE_0__["default"].placeholderInsertionInProgress) return;
    _core_state_js__WEBPACK_IMPORTED_MODULE_0__["default"].placeholderInsertionInProgress = true;
    if ($(e.currentTarget).closest('#modalPlaceholderAccordion').length > 0) {
      _core_state_js__WEBPACK_IMPORTED_MODULE_0__["default"].placeholderInsertionInProgress = false;
      return;
    }
    e.stopPropagation();
    e.preventDefault();
...
var handlePlaceholderClick = function handlePlaceholderClick(internalType, displayName) {
  if (_core_state_js__WEBPACK_IMPORTED_MODULE_0__["default"].isEditingPlaceholder && _core_state_js__WEBPACK_IMPORTED_MODULE_0__["default"].currentEditingVariable) {
    updateExistingPlaceholder(_core_state_js__WEBPACK_IMPORTED_MODULE_0__["default"].currentEditingVariable, internalType, displayName);
...
var TypeHelpers = {
  naturalizeType: function naturalizeType(type) {
    ...
    if (type.startsWith("NNP")) {
      ...
      return Utils.toTitleCase(Utils.naturalDisplay(_sub || "Proper Noun")) + " (Singular)";
    }
    if (type.startsWith("NNS")) {
      ...
      return Utils.toTitleCase(Utils.naturalDisplay(_sub2 || "Common Noun")) + " (Plural)";
    }
    if (type.startsWith("NN")) {
      ...
      return Utils.toTitleCase(Utils.naturalDisplay(_sub3 || "Common Noun")) + " (Singular)";
    }
    if (type.startsWith("NNS")) {
      var _sub4 = type.substring(3);
      if (_sub4.startsWith("_")) _sub4 = _sub4.substring(1);
      _sub4 = _sub4.replace(/\d+$/, '');
      return Utils.toTitleCase(Utils.naturalDisplay(_sub4 || "Common Noun")) + " (Plural)";
    }
    if (type.startsWith("NN")) {
      var _sub5 = type.substring(2);
      if (_sub5.startsWith("_")) _sub5 = _sub5.substring(1);
      _sub5 = _sub5.replace(/\d+$/, '');
      return Utils.toTitleCase(Utils.naturalDisplay(_sub5 || "Common Noun")) + " (Singular)";
    }
    ...
    for (var _tense in verbTenseMap) {
      if (type.startsWith(_tense)) {
        ...
        return category ? Utils.toTitleCase(category) + " Verb (" + verbTenseMap[_tense] + ")" : "Verb (" + verbTenseMap[_tense] + ")";
      }
    }
    ...
    if (type.startsWith("JJ_")) {
      ...
      return Utils.toTitleCase(Utils.naturalDisplay(_sub6));
    }
    if (type.startsWith("JJS_")) {
      ...
      return Utils.toTitleCase(Utils.naturalDisplay(_sub7)) + " Superlative Adjective";
    }
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _core_state_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./core/state.js */ "./public/js/core/state.js");
/* harmony import */ var _handlers_events_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./handlers/events.js */ "./public/js/handlers/events.js");
/* harmony import */ var _ui_menu_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./ui/menu.js */ "./public/js/ui/menu.js");
...
(function () {
  ...
  $(document).ready(function () {
    ...
    (0,_ui_menu_js__WEBPACK_IMPORTED_MODULE_2__.initMenuSystem)();

    // Attach event handlers
    (0,_handlers_events_js__WEBPACK_IMPORTED_MODULE_1__.initEvents)();

    // Load saved stories if the user is logged in
    if ($('#userLoggedIn').val() === 'true') {
      _data_storage_js__WEBPACK_IMPORTED_MODULE_3__.Storage.loadSavedStoriesList();
    }
